...
namespace MediaThor
{
    public interface IMediator
    {
        ...
        /// <returns>A task that contains an async enumerable which contains the handler results.</returns>
        Task<IAsyncEnumerable<TResponse>> CreateStream<TResponse>(IStreamRequest<TResponse> request, CancellationToken cancellationToken = default);
    }
}
